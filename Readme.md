...
然而上述渠道价格偏，一般10%增量后仍比汇率兑换贵一点点。如果你参加工作了，可考虑申请工商银行星座Visa信用卡，它是免年费的，有多币种额度。可在 https://forbooks.jp/zh-hans 购买点数，扣日元额度，之后再在银行app中用RMB账户还款；此网站是官方认可的网站，右上角语言换成英文就能看到。现在也可以直接在付款时用Visa了，曾经有一段时间不让用。
